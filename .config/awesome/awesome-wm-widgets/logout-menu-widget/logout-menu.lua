...
local function worker(user_args)
    ...
    local onreboot = args.onreboot or function() awful.spawn.with_shell("sudo systemctl reboot") end
    local onsuspend = args.onsuspend or function() awful.spawn.with_shell("sudo systemctl suspend") end
    local onpoweroff = args.onpoweroff or function() awful.spawn.with_shell("sudo systemctl poweroff") end
