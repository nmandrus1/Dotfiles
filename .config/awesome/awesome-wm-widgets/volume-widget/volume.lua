...
local function GET_VOLUME_CMD(device) return 'amixer sget Master' end
local function INC_VOLUME_CMD(device, step) return 'amixer sset Master ' .. step .. '%+' end
local function DEC_VOLUME_CMD(device, step) return 'amixer sset Master ' .. step .. '%-' end
local function TOG_VOLUME_CMD(device) return 'amixer sset Master toggle' end
