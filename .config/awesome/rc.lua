...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "w", 
              function () awful.util.spawn(os.getenv("BROWSER") or "brave") end,
              {description = "show main menu", group = "awesome"}),

    awful.key({ modkey,           }, "e", 
              function () awful.util.spawn("neovide") end,
              {description = "launch neovide", group = "awesome"}),
  ...
  -- added user to video group and followed arch wiki
    ...
    awful.key({ modkey },            "d",     function () awful.util.spawn("sh /home/nels/.config/rofi/launchers/colorful/launcher.sh") end,
